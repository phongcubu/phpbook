...
?>
<?php
if(isset($_GET['suatin_id']))
{
    $sql_query =mysqli_query($con, "SELECT * FROM tbl_tintuc WHERE tintuc_id=".$_GET['suatin_id']);
...
if(isset($_POST['update_tin']))
{
    ...
    $path = '../images/product/';
    $sql_insert =mysqli_query($con,"INSERT INTO tbl_tintuc(tintuc_name,tomtat,img_dautrang,noidung_tin,danhmuctin_id,hienthi) 
    values ('$tenTT','$tomtat','$hinhanh_tt','$noidung','$danhmuctin','$hienthi')");
	...
	else
	{
		?>
		<script type="text/javascript">
		alert('Đang lỗi chưa thể nào thêm tin');
		</script>
		<?php
	}
...
if(isset($_POST['btn-thoat']))
    {
        header("Location: quanly_tictuc.php");
    }
?>
<!DOCTYPE html>
<head>
                        ...
                        <div class="position-center">
                            <form role="form" action="#" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="tt_name" id="exampleInputEmail1" placeholder="tên sản phẩm">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control ckeditor" name="tomtat" id="exampleInputEmail1" placeholder="tóm tắt"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Nội dung:</label>
                                    <textarea type="text" class="form-control ckeditor" name="noidung" id="exampleInputEmail1" placeholder="nội dung"></textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <button type="submit" name="update_tin" class="btn btn-info">Thêm tin tức</button>
