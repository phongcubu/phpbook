        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
				...
				<li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="typography.php">Thêm thương hiệu sản phẩm</a></li>
						<li><a href="glyphicon.php">Liệt kê thương hiệu sản phẩm</a></li>
                    </ul>
                </li>
				<li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
						<li><a href="typography.php">Thêm sản phẩm</a></li>
